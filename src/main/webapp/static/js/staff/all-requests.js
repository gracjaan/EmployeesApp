...
function createRejectedWeek(rejectedWeek) {
    ...
    console.log(getName(rejectedWeek.user.firstName, rejectedWeek.user.lastName, rejectedWeek.user.lastNamePrefix));
    ...
    hours.innerText = ((rejectedWeek.totalMinutes) / 60).toString() + " HOURS";
    console.log(rejectedWeek.totalMinutes);
